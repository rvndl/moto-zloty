...
type Fields = InferBody<typeof api.contact.post>;
...
const ContactPage = () => {
  const { mutate: sendContact, isPending } = useMutation(api.contact.post);
        ...
        >
          <Form<Fields>
            ...
            resolver={yupResolver(
              schema as unknown as yup.ObjectSchema<object>,
            )}
          >
