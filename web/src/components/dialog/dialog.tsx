    ...
    <>
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center w-screen max-h-screen">
          <DialogPanel
            transition
            className="relative bg-white border border-separate rounded-lg shadow-sm max-h-screen min-w-96 duration-300 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:translate-y-3 data-[closed]:opacity-0"
          >
